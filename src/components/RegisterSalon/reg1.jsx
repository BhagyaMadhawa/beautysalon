...
export default function SignupSalonOwner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        // Navigate to next registration step with userId as state
  ...
  // After successful salon registration, redirect to dashboard
  // This can be handled in reg2.jsx after salon creation
  ...
  return (
    ...
    >
      ...
      {/* OR divider */}
      <motion.div
        className="flex items-center gap-3 w-full max-w-md mx-auto mb-4"
        variants={fadeInUp}
        custom={3}
      >
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 flex flex-col text-gray-900 text-sm">
            ...
            <input
              ...
              className="border border-gray-200 rounded-lg py-2 px-3 text-sm focus:outline-none focus:border-puce transition"
              value={firstName}
        ...
        <div>
          ...
          <div className="text-xs text-gray-500 mb-2">
            Enter your location to find service providers near you
          </div>
        ...
        <motion.button
          className="w-full bg-puce hover:bg-puce1-600 text-white font-semibold py-3 rounded-lg transition mt-4"
          type="submit"
        ...
        <div className="text-center text-sm text-gray-700 mt-3">
          ...
          <a href="#" className="text-puce underline hover:text-puce1-600">
            Log in
          </a>
        </div>
      </motion.form>
