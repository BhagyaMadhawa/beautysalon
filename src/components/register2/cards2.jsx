...
const UserTypeSelection2 = () => {
  const [selectedType, setSelectedType] = useState("ShopOwner"); // Default to client
  ...
  const userTypes = [
    {
      ...
      icon: Users,
      description: "I Own a Salon with Multiple services",
    },
    {
      id: "individual",
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl mx-auto">
        ...
        >
          <motion.button
            className="w-full sm:w-auto bg-gray-300 text-gray-600 font-semibold px-8 py-3 rounded-lg border hover:border-puce hover:bg-puce1-100 transition-colors duration-200"
          ...
          >
            ...
            <motion.a
              href="/login"
              className="text-puce hover:text-puce1-700 font-medium transition-colors duration-200"
...
export default UserTypeSelection2;
